...
/**
 * Get configured timezone from settings.json (defaults to America/Los_Angeles)
 */
function getTimezone(): string {
  return getPrincipal().timezone || 'America/Los_Angeles';
}
...
export const getPSTTimestamp = getLocalTimestamp;
...
// Alias for backward compatibility
export const getPSTDate = getLocalDate;
...
// Alias for backward compatibility
export const getPSTComponents = getLocalComponents;
