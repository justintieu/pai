...
For simple skills, use this inline process:

1. **Determine name:** kebab-case, `pai-` prefix for PAI skills
...
3. Creates pai-bookmarks with similar pattern
